                ...
                <div class="col-md-12">
                    <div class="wrapper-content">
                        ...
                        <div>
                            ...
                            <span class="download-option vertically-centered"><a href="https://github.com/stevespringett/dependency-track/releases/download/3.0.3/dependency-track-embedded.war">Download <i class="fas fa-download"></i> self-contained application (Requires Java 8 u101+)</a></span>
                        </div>
                        <br/>
                        <div>
                            <span class="caption vertically-centered"><i class="icon-tomcat download-icon"></i></span>
                            <span class="download-option vertically-centered"><a href="https://github.com/stevespringett/dependency-track/releases/download/3.0.3/dependency-track.war">Download <i class="fas fa-download"></i> Java webapp (Requires Java 8 u101+ and Tomcat 8.5+ or Jetty 9.0+)</a></span>
                        </div>
                    </div>
                </div>
            </div>
